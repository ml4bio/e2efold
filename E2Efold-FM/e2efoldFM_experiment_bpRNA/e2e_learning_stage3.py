...
from e2efold_old.models import ContactNetwork, ContactNetwork_test, ContactNetwork_fc
from e2efold_old.models import ContactAttention, ContactAttention_simple_fix_PE
from e2efold_old.models import Lag_PP_NN, RNA_SS_e2e, Lag_PP_zero, Lag_PP_perturb
from e2efold_old.models import Lag_PP_mixed, ContactAttention_simple
from e2efold_old.common.utils import *
from e2efold_old.common.config import process_config
from e2efold_old.evaluation import all_test_only_e2e
...
test_data = RNASSDataGenerator('../data/{}/'.format(data_type), 'test')

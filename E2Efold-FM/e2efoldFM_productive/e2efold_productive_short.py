...
from e2efold.models import Lag_PP_mixed, ContactAttention_simple, No_Noise
#from e2efold.models import NoNoise
...
if LOAD_MODEL and os.path.isfile(e2e_model_path):
    ...
    rna_ss_e2e.load_state_dict(torch.load(e2e_model_path))   # CJY zip load
...
save_npy_dir = "/user/liyu/cjy/RNA/methods/E2Efold-FM/e2efold_productive/short_npy"
